...
const TicketFilters = ({ 
  ...
  const statusOptions = [
    { value: 'all', label: 'All Tickets', count: ticketCounts.all || 0 },
    { value: 'pending', label: 'Pending', count: ticketCounts.pending || 0 },
    { value: 'picked', label: 'In Progress', count: ticketCounts.picked || 0 },
    { value: 'resolved', label: 'Resolved', count: ticketCounts.resolved || 0 },
    { value: 'closed', label: 'Closed', count: ticketCounts.closed || 0 }
  ]
    ...
    <div className="p-4 bg-base-200 border-b border-base-300">
      ...
      <div className="mb-4">
        <div className="relative">
          ...
          <input
            type="text"
            placeholder="Search tickets by customer name, email, or subject..."
      ...
      <div className="flex flex-wrap gap-4">
        ...
        {/* Priority Filter */}
        <div className="flex items-center gap-2">
          <AlertTriangle size={16} className="text-base-content/70" />
          <select
